CREATE DATABASE  IF NOT EXISTS `SNL_Division_DB` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `SNL_Division_DB`;
...
CREATE TABLE `TableDivision` (
  ...
  `DivisionName` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
-- Dump completed on 2020-12-03 17:03:50
