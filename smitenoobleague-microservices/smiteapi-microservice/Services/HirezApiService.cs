                    ...
                    if (matchDetails?.Count() == 10)
                    {
                        ...
                        foreach (var mp in matchDetails)
                        {
                            ...
                            PlayerStat playerStat = new PlayerStat
                            {
                                ...
                                Player = new Player { PlayerID = mp.ActivePlayerId, Playername = (string)(mp.hz_player_name != "" ? mp.hz_player_name : mp.hz_gamer_tag), Platform = mp.playerPortalId.ToString() },
