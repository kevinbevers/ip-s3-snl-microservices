...
namespace stat_microservice.Stat_DB
{
    public partial class SNL_Stat_DBContext : DbContext
    {
        ...
        public virtual DbSet<TableMatchResult> TableMatchResults { get; set; }
        public virtual DbSet<TableStanding> TableStandings { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<TableMatchResult>(entity =>
            {
                entity.HasKey(e => e.MatchResultId)
                    .HasName("PRIMARY");

                entity.ToTable("TableMatchResult");
                ...
                entity.Property(e => e.ScheduleMatchUpId).HasColumnName("ScheduleMatchUpID");

                entity.Property(e => e.WinningTeamId).HasColumnName("WinningTeamID");
            });

            modelBuilder.Entity<TableStanding>(entity =>
            {
                entity.HasKey(e => e.StandingId)
                    .HasName("PRIMARY");

                entity.ToTable("TableStanding");
