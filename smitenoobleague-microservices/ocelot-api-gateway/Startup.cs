    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddCors(options =>
            {
                ...
                builder =>
                {
                    builder.WithOrigins("http://localhost:3000", "https://snl-picks-and-bans.herokuapp.com", domain); //accept only the configured domains. 1 local for development and env variable for production.
