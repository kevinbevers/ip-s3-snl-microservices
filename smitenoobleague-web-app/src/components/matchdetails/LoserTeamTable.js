        ...
        <>
            <Row className="mb-2">
                <Col xl={12} md={12} xs={12} className="mx-auto">
                    ...
                    <Image src="https://web2.hirez.com/esports/teams/ghost-70x70.png" className="TeamLogo" draggable={false}/>
                ...
                <Col xl={12} md={12} xs={12} className="mx-auto">
                    <Table responsive variant="" className="rounded-bottom text-center" id="TeamTable">
                        ...
                        <tbody>
                            ...
                            <td><Image src={playerdata[0]?.god?.godIcon} alt="" className="GodImg" rounded draggable={false}/></td>
                                <td className="text-left"><div className=" d-flex align-items-center"><img src={"/images/roles/" + playerdata[0]?.role.roleName + "_Logo.png"}  height={15} width={15} className="mr-1 my-auto"/> {playerdata[0]?.player?.playername}</div></td>
                                ...
                                <td className="">
                                    <div className="d-flex align-items-center justify-content-center m-0 p-0">
                                        <img src={playerdata[0]?.relic1Icon} className="mr-1 ItemImg" draggable={false}/>
                                        <img src={playerdata[0]?.relic2Icon} className="mr-1 ItemImg" draggable={false}/>
                                    </div>
                                </td>
                                <td className="">
                                    <div className="d-flex align-items-center justify-content-center m-0 p-0">
                                    <img src={playerdata[0]?.item1Icon != null ? playerdata[0]?.item1Icon : "/images/empty_slot.png"} className="mr-1 ItemImg" draggable={false}/>
                                    <img src={playerdata[0]?.item2Icon != null ? playerdata[0]?.item2Icon : "/images/empty_slot.png"} className="mr-1 ItemImg" draggable={false}/>
                                    <img src={playerdata[0]?.item3Icon != null ? playerdata[0]?.item3Icon : "/images/empty_slot.png"} className="mr-1 ItemImg" draggable={false}/>
                                    <img src={playerdata[0]?.item4Icon != null ? playerdata[0]?.item4Icon : "/images/empty_slot.png"} className="mr-1 ItemImg" draggable={false}/>
                                    <img src={playerdata[0]?.item5Icon != null ? playerdata[0]?.item5Icon : "/images/empty_slot.png"} className="mr-1 ItemImg" draggable={false}/>
                                    <img src={playerdata[0]?.item6Icon != null ? playerdata[0]?.item6Icon : "/images/empty_slot.png"} className="mr-1 ItemImg" draggable={false}/>
                                    </div>
                                </td>
                            </tr>
                            <tr className="table-danger2">
                            <td><Image src={playerdata[1]?.god?.godIcon} alt="" className="GodImg" rounded draggable={false}/></td>
                            <td className="text-left"><div className=" d-flex align-items-center"><img src={"/images/roles/" + playerdata[1]?.role.roleName + "_Logo.png"}  height={15} width={15} className="mr-1 my-auto"/> {playerdata[1]?.player?.playername}</div></td>
                                ...
                                <td className="text-left">
                                    <div className="d-flex align-items-center justify-content-center m-0 p-0">
                                    <img src={playerdata[1]?.item1Icon != null ? playerdata[1]?.item1Icon : "/images/empty_slot.png"} className="mr-1 ItemImg" draggable={false}/>
                                    <img src={playerdata[1]?.item2Icon != null ? playerdata[1]?.item2Icon : "/images/empty_slot.png"} className="mr-1 ItemImg" draggable={false}/>
                                    <img src={playerdata[1]?.item3Icon != null ? playerdata[1]?.item3Icon : "/images/empty_slot.png"} className="mr-1 ItemImg" draggable={false}/>
                                    <img src={playerdata[1]?.item4Icon != null ? playerdata[1]?.item4Icon : "/images/empty_slot.png"} className="mr-1 ItemImg" draggable={false}/>
                                    <img src={playerdata[1]?.item5Icon != null ? playerdata[1]?.item5Icon : "/images/empty_slot.png"} className="mr-1 ItemImg" draggable={false}/>
                                    <img src={playerdata[1]?.item6Icon != null ? playerdata[1]?.item6Icon : "/images/empty_slot.png"} className="mr-1 ItemImg" draggable={false}/>
                                    </div>
                                </td>
                            </tr>
                            <tr className="table-danger">
                            <td><Image src={playerdata[2]?.god?.godIcon} alt="" className="GodImg" rounded draggable={false}/></td>
                            <td className="text-left"><div className=" d-flex align-items-center"><img src={"/images/roles/" + playerdata[2]?.role.roleName + "_Logo.png"}  height={15} width={15} className="mr-1 my-auto"/> {playerdata[2]?.player?.playername}</div></td>
                            ...
                            <tr className="table-danger2">
                            <td><Image src={playerdata[3]?.god.godIcon} alt="" className="GodImg" rounded draggable={false}/></td>
                            <td className="text-left"><div className=" d-flex align-items-center"><img src={"/images/roles/" + playerdata[3]?.role.roleName + "_Logo.png"}  height={15} width={15} className="mr-1 my-auto"/> {playerdata[3]?.player?.playername}</div></td>
                            ...
                            <tr className="table-danger">
                            <td><Image src={playerdata[4]?.god?.godIcon} alt="" className="GodImg" rounded draggable={false}/></td>
                            <td className="text-left"><div className=" d-flex align-items-center"><img src={"/images/roles/" + playerdata[4]?.role.roleName + "_Logo.png"}  height={15} width={15} className="mr-1 my-auto"/> {playerdata[4]?.player?.playername}</div></td>
