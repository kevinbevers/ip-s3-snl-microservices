  ...
  return (
    <>
      ...
      <Container className="mt-4">
        <MatchHistoryCard team1_name={'Teamname'} total_score={'2 - 0'} team2_name={'Teamname'} matchID={5234534}/>
        <MatchHistoryCard team1_name={'Teamname'} total_score={'2 - 0'} team2_name={'Teamname'} matchID={5234534}/>
        <MatchHistoryCard team1_name={'Teamname'} total_score={'2 - 0'} team2_name={'Teamname'}/>
        <MatchHistoryCard team1_name={'Teamname'} total_score={'2 - 0'} team2_name={'Teamname'}/>
        <MatchHistoryCard team1_name={'Teamname'} total_score={'2 - 0'} team2_name={'Teamname'}/>
        <MatchHistoryCard team1_name={'Teamname'} total_score={'2 - 0'} team2_name={'Teamname'}/>
