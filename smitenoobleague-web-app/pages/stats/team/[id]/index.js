            ...
            <Row className="mt-3">
                ...
                <Row className="mb-4">
                    <Col className="d-flex">
                        ...
                        <Link href={`/stats/player/${TeamStats.starPlayer.playerID}`}><a className="link-unstyled my-auto"><h3 className="my-auto RecentTeamPlayerName Clickable Hoverable" title={"click to see player stats"}>{TeamStats?.starPlayer?.teamMemberName}</h3></a></Link></>
                ...
                <Row className="mb-4">
                    <Col className="d-flex">
                        ...
                        <Link href={`/stats/player/${teamMembers[0]?.playerID}`}><a className="link-unstyled my-auto"><h3 className="my-auto RecentTeamPlayerName Clickable Hoverable" title="click to see player stats">{teamMembers[0]?.teamMemberName != null ? teamMembers[0]?.teamMemberName : "No player in this role yet"}</h3></a></Link>{teamMembers[0]?.teamCaptain ? <Badge variant="secondary" className="my-auto ml-1 mr-1 StatBadge">Captain</Badge> : <> </>}
                    </Col>
                </Row>
                <Row className="mb-4">
                    <Col className="d-flex">
                        <Img webp src={require("public/images/roles/Jungle_Logo.png")} className="GodImgStats mr-2" draggable={false}/>
                        <Link href={`/stats/player/${teamMembers[1]?.playerID}`}><a className="link-unstyled my-auto"><h3 className="my-auto RecentTeamPlayerName Clickable Hoverable" title="click to see player stats">{teamMembers[1]?.teamMemberName != null ? teamMembers[1]?.teamMemberName : "No player in this role yet"}</h3></a></Link>{teamMembers[1]?.teamCaptain ? <Badge variant="secondary" className="my-auto ml-1 mr-1 StatBadge">Captain</Badge> : <> </>}
                    </Col>
                </Row>
                <Row className="mb-4">
                    <Col className="d-flex">
                        <Img webp src={require("public/images/roles/Mid_Logo.png")} className="GodImgStats mr-2" draggable={false}/>
                        <Link href={`/stats/player/${teamMembers[2]?.playerID}`}><a className="link-unstyled my-auto"><h3 className="my-auto RecentTeamPlayerName Clickable Hoverable" title="click to see player stats">{teamMembers[2]?.teamMemberName != null ? teamMembers[2]?.teamMemberName : "No player in this role yet"}</h3></a></Link>{teamMembers[2]?.teamCaptain ? <Badge variant="secondary" className="my-auto ml-1 mr-1 StatBadge">Captain</Badge> : <> </>}
                    </Col>
                </Row>
                <Row className="mb-4">
                    <Col className="d-flex">
                        <Img webp src={require("public/images/roles/Support_Logo.png")} className="GodImgStats mr-2" draggable={false}/>
                        <Link href={`/stats/player/${teamMembers[3]?.playerID}`}><a className="link-unstyled my-auto"><h3 className="my-auto RecentTeamPlayerName Clickable Hoverable" title="click to see player stats">{teamMembers[3]?.teamMemberName != null ? teamMembers[3]?.teamMemberName : "No player in this role yet"}</h3></a></Link>{teamMembers[3]?.teamCaptain ? <Badge variant="secondary" className="my-auto ml-1 mr-1 StatBadge">Captain</Badge> : <> </>}
                    </Col>
                </Row>
                <Row className="mb-4">
                    <Col className="d-flex">
                        <Img webp src={require("public/images/roles/Adc_Logo.png")} className="GodImgStats mr-2" draggable={false}/>
                        <Link href={`/stats/player/${teamMembers[4]?.playerID}`}><a className="link-unstyled my-auto"><h3 className="my-auto RecentTeamPlayerName Clickable Hoverable" title="click to see player stats">{teamMembers[4]?.teamMemberName != null ? teamMembers[4]?.teamMemberName : "No player in this role yet"}</h3></a></Link>{teamMembers[4]?.teamCaptain ? <Badge variant="secondary" className="my-auto ml-1 mr-1 StatBadge">Captain</Badge> : <> </>}
                    </Col>
                </Row>
                </Col>
