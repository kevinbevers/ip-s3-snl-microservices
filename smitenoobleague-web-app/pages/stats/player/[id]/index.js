      ...
      <Container fluid className="mt-2">
          ...
          <Row className="">
            ...
            <Row className="mt-3">
                ...
                <Row className="mb-4">
                <Col className="d-flex">
                <OverlayTrigger placement="bottom" overlay={PlayerStats?.topBansAgainst?.length > 0 ? SimpleToolTip(PlayerStats?.topBansAgainst[0]) : SimpleToolTip(null)}><div className="GodImgStats position-relative mr-1"><Image layout="fill" src={PlayerStats?.topBansAgainst?.length > 0 ? PlayerStats?.topBansAgainst[0]?.godIcon != null ? PlayerStats?.topBansAgainst[0]?.godIcon : "/images/empty_slot.png" : "/images/empty_slot.png"} alt="" className="rounded" draggable={false}/></div></OverlayTrigger>
                <OverlayTrigger placement="bottom" overlay={PlayerStats?.topBansAgainst?.length > 1 ? SimpleToolTip(PlayerStats?.topBansAgainst[1]) : SimpleToolTip(null)}><div className="GodImgStats position-relative mr-1"><Image layout="fill" src={PlayerStats?.topBansAgainst?.length > 1 ? PlayerStats?.topBansAgainst[1]?.godIcon != null ? PlayerStats?.topBansAgainst[1]?.godIcon : "/images/empty_slot.png" : "/images/empty_slot.png"} alt="" className="rounded" draggable={false}/></div></OverlayTrigger>
                <OverlayTrigger placement="bottom" overlay={PlayerStats?.topBansAgainst?.length > 2 ? SimpleToolTip(PlayerStats?.topBansAgainst[2]) : SimpleToolTip(null)}><div className="GodImgStats position-relative mr-1"><Image layout="fill" src={PlayerStats?.topBansAgainst?.length > 2 ? PlayerStats?.topBansAgainst[2]?.godIcon != null ? PlayerStats?.topBansAgainst[2]?.godIcon : "/images/empty_slot.png" : "/images/empty_slot.png"} alt="" className="rounded" draggable={false}/></div></OverlayTrigger>
                <OverlayTrigger placement="bottom" overlay={PlayerStats?.topBansAgainst?.length > 3 ? SimpleToolTip(PlayerStats?.topBansAgainst[3]) : SimpleToolTip(null)}><div className="GodImgStats position-relative mr-1"><Image layout="fill" src={PlayerStats?.topBansAgainst?.length > 3 ? PlayerStats?.topBansAgainst[3]?.godIcon != null ? PlayerStats?.topBansAgainst[3]?.godIcon : "/images/empty_slot.png" : "/images/empty_slot.png"} alt="" className="rounded" draggable={false}/></div></OverlayTrigger>
                <OverlayTrigger placement="bottom" overlay={PlayerStats?.topBansAgainst?.length > 4 ? SimpleToolTip(PlayerStats?.topBansAgainst[4]) : SimpleToolTip(null)}><div className="GodImgStats position-relative mr-1"><Image layout="fill" src={PlayerStats?.topBansAgainst?.length > 4 ? PlayerStats?.topBansAgainst[4]?.godIcon != null ? PlayerStats?.topBansAgainst[4]?.godIcon : "/images/empty_slot.png" : "/images/empty_slot.png"} alt="" className="rounded" draggable={false}/></div></OverlayTrigger>
                    </Col>
                </Row>
                <Row className="mb-4">
                <Col className="">
