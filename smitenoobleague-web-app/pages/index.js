...
function Home({LoginSession}) {
  ...
  <div className="jumbotron-fluid">
    ...
    <div className=" container mb-2 mt-5 rounded p-4" id="welcomeScreen">
        <Row className="mb-2"><Col className="d-flex justify-content-center"><Img alt={"SNL Roadmap"} webp sizes={[300,350,400,1024]} src={require("public/images/SCL_Logo.png")} className="LandingImage" draggable={false}></Img></Col></Row>
